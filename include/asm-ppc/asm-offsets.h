...
#define THREAD 432 /* offsetof(struct task_struct, thread)	 # */
#define THREAD_INFO 4 /* offsetof(struct task_struct, thread_info)	 # */
#define MM 132 /* offsetof(struct task_struct, mm)	 # */
...
#define LAST_SYSCALL 16 /* offsetof(struct thread_struct, last_syscall)	 # */
...
#define CPU_SPEC_ENTRY_SIZE 64 /* sizeof(struct cpu_spec)	 # */
...
#define TI_FLAGS 40 /* offsetof(struct thread_info, flags)	 # */
#define TI_LOCAL_FLAGS 36 /* offsetof(struct thread_info, local_flags)	 # */
